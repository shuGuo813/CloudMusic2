...
/** 
 * DAO for table "MUSIC_CLOUD_BEAN".
*/
public class MusicCloudBeanDao extends AbstractDao<MusicCloudBean, Long> {

    public static final String TABLENAME = "MUSIC_CLOUD_BEAN";

    /**
     * Properties of entity MusicCloudBean.<br/>
    ...
    */
    ...
    public MusicCloudBeanDao(DaoConfig config) {
        super(config);
    }
    
    public MusicCloudBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MUSIC_CLOUD_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MUSIC_CLOUD_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MusicCloudBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MusicCloudBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public MusicCloudBean readEntity(Cursor cursor, int offset) {
        MusicCloudBean entity = new MusicCloudBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, MusicCloudBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MusicCloudBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MusicCloudBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
