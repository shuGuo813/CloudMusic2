...
/** 
 * DAO for table "MUSIC_LIST_BEAN".
*/
public class MusicListBeanDao extends AbstractDao<MusicListBean, Long> {

    public static final String TABLENAME = "MUSIC_LIST_BEAN";

    /**
     * Properties of entity MusicListBean.<br/>
    ...
    */
    ...
    public MusicListBeanDao(DaoConfig config) {
        super(config);
    }
    
    public MusicListBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MUSIC_LIST_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MUSIC_LIST_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MusicListBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MusicListBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public MusicListBean readEntity(Cursor cursor, int offset) {
        MusicListBean entity = new MusicListBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, MusicListBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MusicListBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MusicListBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
